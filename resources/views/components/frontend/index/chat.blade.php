<div class="me-3">
    <a href="#" class="btn btn-icon btn-custom btn-active-color-primary position-relative" data-kt-menu-trigger="click"
        title="Notification" data-bs-toggle="tooltip" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
        ...
        <div class="d-flex flex-column bgi-no-repeat rounded-top"
            ...
            <!--begin::Title-->
            <h3 class="text-dark fw-bold px-9 mt-10 mb-6">Chat
                <span class="fs-8 opacity-75 ps-3">24 New Message</span>
            </h3>
            <!--end::Title-->
